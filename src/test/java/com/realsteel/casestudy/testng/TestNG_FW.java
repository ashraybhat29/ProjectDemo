...
public class TestNG_FW
{
	...
	// 1st wrong username and password
			...
			String producttosearch=DataHandlers.getDataFromExcel("data","TC02", 0, 0);
			
			String addcartquantity=DataHandlers.getDataFromExcel("data", "TC04", 1, 1);
			String shoppingquantity=DataHandlers.getDataFromExcel("data", "TC04", 1, 2);
			
			String searchproduct= DataHandlers.getDataFromExcel("data", "TC06", 1, 0);
			
			String telephonenumber= DataHandlers.getDataFromExcel("data", "TC07", 1, 0);
			String firstdropdown=  DataHandlers.getDataFromExcel("data", "TC08", 1, 0);
			String seconddropdown=  DataHandlers.getDataFromExcel("data", "TC08", 2, 0); 
			
			String firstname   = DataHandlers.getDataFromExcel("data", "TC10", 1, 3);
			String lastname    = DataHandlers.getDataFromExcel("data", "TC10", 1, 4);
			String company     = DataHandlers.getDataFromExcel("data", "TC10", 1, 5);
			String address1    = DataHandlers.getDataFromExcel("data", "TC10", 1, 6);
			String address2    = DataHandlers.getDataFromExcel("data", "TC10", 1, 7);
			String city        = DataHandlers.getDataFromExcel("data", "TC10", 1, 8);
			String postcode    = DataHandlers.getDataFromExcel("data", "TC10", 1, 9);
			String country     = DataHandlers.getDataFromExcel("data", "TC10", 1, 10);
			String regionstate = DataHandlers.getDataFromExcel("data", "TC10", 1, 11);
	...
	public void TC002_E2E(String search,String quantity,String shoppingquantity ) throws InterruptedException
	{
	  ...
	  // step 12 to 16
	    ...
	    Utility.captureScreenshot(driver, " 12 checkout " +searchproduct);
	...
	public void TC004_OrderQuantity(String search,String quantity,String shoppingquantity )throws InterruptedException
	{
		...
		//7th step Enter 2 in Qunatity field
	...
	@Test
	public void TC006_AdditionalImage() throws InterruptedException
	
	{
		 producttosearch=DataHandlers.getDataFromExcel("data","TC06", 1, 0);
		try {
			//2st step
			login();
			Utility.captureScreenshot(driver, "2 Login");
	...
	@Test
	public void TC007_EditAccountInfo() throws InterruptedException
	{
		try {
	...
	@Test
	public void TC008_SortByCombo() throws InterruptedException
	{
		try {
			//2st step
			login();
	...
	@Test
	public void TC010_ChangeAddress()  
	{
		searchproduct= DataHandlers.getDataFromExcel("data", "TC10", 1, 0);
		
		
		addcartquantity=DataHandlers.getDataFromExcel("data", "TC10", 1, 1);
		shoppingquantity=DataHandlers.getDataFromExcel("data", "TC10", 1, 2);
